...
alter table CO_ACTION
  add constraint PK_CO_ACTION primary key (ID); 
...
alter table CO_APPLICATION
  add constraint PK_CO_APPLICATION primary key (ID);
alter table CO_APPLICATION
...
alter table CO_APP_REFRESH_TOKEN
  add constraint PK_CO_APP_REFRESH_TOKEN_ID primary key (ID);
alter table CO_APP_REFRESH_TOKEN
...
alter table CO_APP_USCS_ACCSS
  add constraint PK_APP_USCS_ACCSS primary key (ID);
alter table CO_APP_USCS_ACCSS
...
alter table CO_ATTACHMENT
  add constraint PK_CO_ATTACHMENT primary key (ID);
/*----------------------------- CO_MENU -----------------------------------*/
...
alter table CO_PORTAL
  add constraint PK_CO_PORTAL_ID primary key (ID);
alter table CO_PORTAL
...
alter table CO_PORTAL_SYS_ACCSS
  add constraint PK_CO_PORTAL_SYS_ACCSS_ID primary key (ID);
alter table CO_PORTAL_SYS_ACCSS
...
alter table CO_REVISION
  add constraint PK_CO_REVISION_ID primary key (ID);
...
alter table CO_ROLE
  add constraint PK_CO_ROLE primary key (ID);
alter table CO_ROLE
...
alter table CO_ROLE_ORGANIZATION_ACSS
  add constraint PK_CO_ROLE_ORGNZTION_ACSS_ID primary key (ID);
alter table CO_ROLE_ORGANIZATION_ACSS
...
alter table CO_ROLE_SUBSYSTEM_ACSS
  add constraint PK_CO_ROLE_SUBSYSTEM_ACSS primary key (ID);
alter table CO_ROLE_SUBSYSTEM_ACSS
...
alter table CO_ROLE_USCS_ACTN_ACCS
  add constraint PK_CO_ROLE_USCS_ACTN_ACCS primary key (ID);
alter table CO_ROLE_USCS_ACTN_ACCS
...
alter table CO_ROLE_USECASE_ACSS
  add constraint PK_CO_USECASE_ROLE_ACSS primary key (ID);
alter table CO_ROLE_USECASE_ACSS
...
alter table CO_SEQUENCE
  add constraint PK_CO_SEQUENCE primary key (ID);
alter table CO_SEQUENCE
  add constraint UN_CO_SEQUNCE_TABLE_NAME unique (TABLE_NAME);
/*----------------------------- CO_SETTINGS -----------------------------------*/
...
alter table CO_SETTINGS
  add constraint PK_CO_SETTING_ID primary key (ID);
alter table CO_SETTINGS
...
alter table CO_USECASE
  add constraint PK_CO_USECASE primary key (ID);
alter table CO_USECASE
...
alter table CO_USECASE_ACTION
  add constraint PK_CO_USECASE_ACTION primary key (ID);
alter table CO_USECASE_ACTION
...
alter table CO_USER
  add constraint PK_CO_USER primary key (ID);
alter table CO_USER
...
alter table CO_USER_APP_TOKEN
  add constraint PK_CO_USER_APP_TOKEN primary key (ID);
alter table CO_USER_APP_TOKEN
...
alter table CO_USER_LOG
  add constraint PK_CO_USER_LOG_ID primary key (ID);
alter table CO_USER_LOG
  add constraint FK_CO_USER_LOG_APP_TOKEN_ID foreign key (CO_USER_APP_TOKEN_ID)
  references CO_USER_APP_TOKEN (ID) ;
/*----------------------------- CO_USER_LOG_DTL -----------------------------------*/
...
alter table CO_USER_ORGANIZATION_ACSS
  add constraint PK_CO_USER_ORGNZTION_ACSS_ID primary key (ID);
alter table CO_USER_ORGANIZATION_ACSS
...
alter table CO_USER_ROLES
  add constraint PK_CS_USER_ROLES3 primary key (ID);
alter table CO_USER_ROLES
...
alter table CO_USER_USECASE_ACSS
  add constraint PK_CO_USECASE_USER primary key (ID);
alter table CO_USER_USECASE_ACSS
...
alter table CO_USR_USCS_ACTN_ACCS
  add constraint PK_CO_USR_USCS_ACTN primary key (ID);
alter table CO_USR_USCS_ACTN_ACCS
...
alter table CM_BANK
  add constraint PK_CM_BANK primary key (ID);
...
alter table CM_BPARTNER
  add constraint PK_CM_BPARTNER4 primary key (ID);
...
alter table CM_BANK_BRANCH
  add constraint PK_CM_BANK_BRANCH primary key (ID);
alter table CM_BANK_BRANCH
  add constraint FK_CM_BANK foreign key (CM_BANK_ID)
  references CM_BANK (ID);
/*----------------------------- CM_CITY -----------------------------------*/
...
alter table CM_CITY
  add constraint PK_CM_CITY primary key (ID);
...
alter table CM_COMPANY_BPARTNER
  add constraint PK_CM_COMPANY_BPARTNER primary key (ID);
alter table CM_COMPANY_BPARTNER
  add constraint FK_CM_COMPANY_PARENT foreign key (PARENT_COMPANY)
  references CM_COMPANY_BPARTNER (ID);
alter table CM_COMPANY_BPARTNER
  add constraint FK_CM_COMP_BPART_CM_BPARTNER foreign key (CM_BPARTNER_ID)
  references CM_BPARTNER (ID);
alter table CM_COMPANY_BPARTNER
  add constraint UN_CM_CBPARTNER_BP_ID UNIQUE(CM_BPARTNER_ID);
/*----------------------------- CM_COUNTRY -----------------------------------*/
...
alter table CM_COUNTRY
  add constraint PK_CM_COUNTRY primary key (ID);
/*----------------------------- CM_COUNTRY -----------------------------------*/
...
alter table CM_CURRENCY
  add constraint PK_CM_CURRENCY primary key (ID);
/*----------------------------- CM_CUSTOMER -----------------------------------*/
...
alter table CM_CUSTOMER
  add constraint PK_CM_CUSTOMER primary key (ID);
alter table CM_CUSTOMER
...
alter table CM_DOCTYPE
  add constraint PK_CM_DOCTYPE primary key (ID);
alter table CM_DOCTYPE
...
alter table CM_DOCTYPE_DIMENSION
  add constraint PK_CM_DOCTYPE_DIMENSION primary key (ID);
alter table CM_DOCTYPE_DIMENSION
...
alter table CM_DOC_STATUS
  add constraint PK_CM_DOC_STATUS primary key (ID);
alter table CM_DOC_STATUS
...
alter table CM_EMPLOYEE
  add constraint PK_CM_EMPLOYEE primary key (ID);
alter table CM_EMPLOYEE
  add constraint FK_CM_EMP_MANAGER foreign key (MANAGER_ID)
  references CM_EMPLOYEE (ID);
/*----------------------------- CM_FISCALYEAR -----------------------------------*/
...
alter table CM_FISCALYEAR
  add constraint PK_CM_FISCALYEAR primary key (ID);
alter table CM_FISCALYEAR
...
alter table CM_LOCATION
  add constraint PK_CM_LOCATION primary key (ID);
alter table CM_LOCATION
  add constraint FK_CM_LOCATION_CM_LOCATION foreign key (PARENT_ID)
  references CM_LOCATION (ID);
alter table CM_LOCATION
...
alter table CM_ORGAN_LOCATION
  add constraint PK_CM_ORG_LOC primary key (ID);
alter table CM_ORGAN_LOCATION
...
alter table CM_PERSON_BPARTNER
  add constraint PK_CM_PERSON_BPARTNER primary key (ID);
alter table CM_PERSON_BPARTNER
  add constraint FK_CM_PERSON_BPARTNER foreign key (CM_BPARTNER_ID)
  references CM_BPARTNER (ID) ;
alter table CM_PERSON_BPARTNER
  add constraint UN_CM_PBPARTNER_BP_ID UNIQUE(CM_BPARTNER_ID);  
 /*----------------------------- CM_PROVINCE -----------------------------------*/
...
alter table CM_PROVINCE
  add constraint PK_CM_PROVINCE primary key (ID);
 /*----------------------------- CM_REGION -----------------------------------*/
...
alter table CM_ROLE_DOCSTATUS_ACCESS
  add constraint PK_CM_ROLE_DOCSTATUS_ACCESS primary key (ID);
alter table CM_ROLE_DOCSTATUS_ACCESS
...
alter table CM_STATE
  add constraint PK_CM_STATE primary key (ID);
alter table CM_STATE
...
alter table CM_SUBSYSTEM
  add constraint PK_CM_SUBSYSTEM8 primary key (ID);
alter table CM_SUBSYSTEM
...
alter table CM_SUPPLIER
  add constraint PK_CM_SUPPLIER primary key (ID);
alter table CM_SUPPLIER
...
alter table CM_SUPPLIER
  ...
  references CM_PERSON_BPARTNER (ID);
/*----------------------------- CM_SYSTEM -----------------------------------*/
...
alter table CM_SYSTEM
  add constraint PK_CM_SYSTEM9 primary key (ID);
alter table CM_SYSTEM
...
alter table CM_TRANSITION
  add constraint PK_CM_TRANSITION_ID primary key (ID);
alter table CM_TRANSITION
...
alter table CM_TRANSITION_HISTORY
  add constraint PK_CM_TRANSITION_HISTORY_ID primary key (ID);
alter table CM_TRANSITION_HISTORY
  add constraint FK_CM_TRANSITION_HS_TRS_ID foreign key (CM_TRANSITION_ID)
  references CM_TRANSITION (ID) ;
alter table CM_TRANSITION_HISTORY
...
alter table CM_USER_DOCSTATUS_ACCESS
  add constraint PK_CM_USER_DOCSTATUS_ACCESS primary key (ID);
alter table CM_USER_DOCSTATUS_ACCESS
